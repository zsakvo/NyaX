...
import 'package:nyax/logic/correlation_list.dart';
import 'package:nyax/widget/loading.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class CorrelationListPage extends StatelessWidget {
  CorrelationListPage({Key key}) : super(key: key);
  final CorrelationListLogic logic = Get.put(CorrelationListLogic());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CorrelationListLogic>(
      builder: (logic) {
        return Scaffold(
          appBar: AppBar(
            titleSpacing: 0,
  ...
  Widget _buildListInkWell(BookCorrelation list) {
    return InkWell(
      ...
      onTap: () {
        Get.toNamed("/correlation", arguments: list);
  ...
  _switchTypes() {
    ...
    Get.bottomSheet(GetBuilder<CorrelationListLogic>(
      builder: (controller) {
        return Container(
