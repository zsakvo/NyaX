...
//   bool shouldJustifyHeight;
//   Widget getPage(TextPage page, String title, [bool debugPrint = false]) {
//     final child = CustomPaint(
//         painter: PagePainter(
//             page, boxSize, title, titleStyle, shouldJustifyHeight, debugPrint));
//     return Container(
//       width: boxSize.width,
//       height: boxSize.height,
//       child: child,
...
//   PagePainter(this.page, this.boxSize, this.title, this.titleStyle,
//       this.shouldJustifyHeight, this.debugPrint);
...
//   @override
//   void paint(Canvas canvas, Size size, [bool debugPrint = false]) {
//     if (debugPrint)
//       print("****** [TextComposition paint start] [${DateTime.now()}] ******");
//     var justify = 0.0;
//     if (shouldJustifyHeight && page.shouldJustifyHeight) {
